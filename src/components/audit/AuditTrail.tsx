...
const MODULES = ['students', 'academic_years', 'boards', 'branches', 'classes', 'courses', 'batches', 'fee_heads', 'fee_structures', 'student_fees', 'ptm_records', 'payments', 'receipts', 'discounts', 'users'];
